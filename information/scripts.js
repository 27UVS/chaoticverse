...
const informationNewCharactersEN = `At the moment, the project practically does not accept applications for 
            adding new characters, but in the future it is planned to organize an application form.`;
...
const informationHowChaoticverseIsWorking2RU = `Причиной подобного явления стали действия Эррора в
            ...
            что персонажи, чьих альтернативных версий не должно было существовать, начали постепенно появляться,
...
const informationNewCharactersRU = `На данный момент проект практически не принимает заявки на добавление новых персонажей,
