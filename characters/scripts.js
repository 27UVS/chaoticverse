...
const characterNelsonDescriptionRU = `Одна из центральных фигур Chaoticverse.
                    ...
                    который оказался в мире игры Undertale. Изначально тот, в ком не было таких качеств, 
                    как сострадание и добродушие, в последствии обрёл их, испытав на себе свои же поступки.
...
const characterHollowSansDescriptionRU = `Тот, чья душа навечно пуста. Мировоззрение: вне данного понятия.
                    ...
                    рядом, и эта нужда — его извечное проклятье, ведь каждый, в ком он нуждается, рано или поздно,
                    будет им поглощен.`;
...
const characterDreamDescriptionRU = `Несмотря на все, что он пережил, его душа
...
const characterNightmareDescriptionRU = `Нет, это не тот Найтмер, которого вы знаете.
                    ...
                    все так же жесток, расчетлив и холоден. Все в его глазах настоящие эгоисты, ничтожества и лицемеры,
                    заслуживающие лишь одного - страдания. Тем не менее его душа не полностью окутана тьмой.`;
